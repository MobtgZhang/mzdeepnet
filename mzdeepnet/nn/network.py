import numpy as np
from mzdeepnet.base import Model, ParamMixin, CollectionMixin
from mzdeepnet.feed import Feed
from mzdeepnet.loss import SoftmaxCrossEntropy

class Network(Model, CollectionMixin):
